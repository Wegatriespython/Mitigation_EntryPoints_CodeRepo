...
def run_transport_cluster_analysis():
    ...
    for i, cluster in enumerate(cluster_names):
        ...
        for train_index, val_index in cv.split(X_resampled, y_resampled):
            ...
            cv_roc_auc.append(safe_roc_auc_score(y_val, y_pred_proba))
        ...
        results['ROC AUC'].append(np.nanmean(cv_roc_auc))
    ...
    # Print results table
    print("\n Transport Cluster Analysis Results:")
    print(final_results.to_string(index=False))

if __name__ == "__main__":
    run_transport_cluster_analysis()
