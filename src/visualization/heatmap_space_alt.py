...
def clean_labels(labels):
    ...
    cleanup_dict = {
        ...
        'e_eu_regulation_creating_transboundary_market': 'EU Regulation',
        'e_pilot_projects': 'Pilot Project',
        't_maturity_oil_industry_expertise': 'Oil Industry Expertise',
        'e_gdp': 'GDP',
        'i_policy_narrative': 'Policy Narrative',
        's_nuclear_phase_out': 'Nuclear Phase Out',
                ...
                if any(v >= threshold for v in values):
                    ...
                    for k, value in enumerate(values):
                        if value >= threshold:
                            ...
                            x_position = j + 0.5 + (k - (n_clusters - 1) / 2) * 0.1
